...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { responsetime: @performance.responsetime } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { responsetime: @performance.responsetime } }
