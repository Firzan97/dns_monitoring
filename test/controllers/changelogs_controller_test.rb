...
class ChangelogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create changelog" do
    assert_difference('Changelog.count') do
      post changelogs_url, params: { changelog: { dnsname: @changelog.dnsname, ipaddress: @changelog.ipaddress, typeanswer: @changelog.typeanswer } }
    end
  ...
  test "should update changelog" do
    patch changelog_url(@changelog), params: { changelog: { dnsname: @changelog.dnsname, ipaddress: @changelog.ipaddress, typeanswer: @changelog.typeanswer } }
