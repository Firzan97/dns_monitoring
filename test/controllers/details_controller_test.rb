...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { average: @detail.average, maximum: @detail.maximum, minimum: @detail.minimum, status: @detail.status } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { average: @detail.average, maximum: @detail.maximum, minimum: @detail.minimum, status: @detail.status } }
