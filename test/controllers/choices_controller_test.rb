...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { graphinterval: @choice.graphinterval, question: @choice.question, question_id: @choice.question_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { graphinterval: @choice.graphinterval, question: @choice.question, question_id: @choice.question_id } }
